...
/// Data element of a Rollbar payload
@interface RollbarData : RollbarDTO
...
@property (nonatomic, nullable) RollbarDTO *client;

/// Optional: custom
/// Any arbitrary metadata you want to send. "custom" itself should be an object.
@property (nonatomic, nullable) NSObject<RollbarJSONSupport> *custom;
...
/// @param body a bodyelement of the payload
