let crashReportAbort = """
    ...
    2   Crash-Tester                    0x000668a8 0x5f000 + 30888 (-[Crasher doAbort] + 8)
    3   Crash-Tester                    0x00065628 0x5f000 + 26152 (__32-[AppDelegate(UI) crashCommands]_block_invoke375 + 68)
    4   Crash-Tester                    0x00065d50 0x5f000 + 27984 (-[CommandEntry executeWithViewController:] + 52)
    5   Crash-Tester                    0x00066400 0x5f000 + 29696 (-[CommandTVC tableView:didSelectRowAtIndexPath:] + 188)
    ...
    18  Crash-Tester                    0x000607b8 0x5f000 + 6072 (main + 164)
    ...
    2   Crash-Tester                    0x00092c38 0x5f000 + 212024 (-[KSCrashDeadlockMonitor runMonitor] + 264)
    ...
    2   Crash-Tester                    0x0008bce0 0x5f000 + 183520 (ksmachexc_i_handleExceptions + 112)
    3   libsystem_c.dylib               0x36264310 0x36231000 + 209680 (_pthread_start + 248)

    Thread 7 name:  KSCrash Exception Handler (Primary)
    Thread 7:
    0   libsystem_kernel.dylib          0x3618bc00 0x3617c000 + 64512 (mach_msg_trap + 20)
    1   Crash-Tester                    0x0008bd28 0x5f000 + 183592 (ksmachexc_i_handleExceptions + 184)
    ...
    Stack Dump (0x2fe5c7a4-0x2fe5c81c):

    FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF070719192C2C2F2F070719192C2C2F2F9D00002307060000AC9D0A00897C0935F0C7E52FFFCB2536897C0935DFFFFFFF00C8E52FFFFFFFFF00C8E52FAF68060099950900E083DD1E18C8E52F2B560600897C0935449D0A00D043DE1E20DBDB1E30C8E52F
            ...
            "ivars": {
                "_commands": {
                    ...
                    "first_object": {
                        ...
                        "last_deallocated_obj": "UIDeviceWhiteColor",
                        "type": "objc_object"
                    },
                    "type": "objc_object"
                },
